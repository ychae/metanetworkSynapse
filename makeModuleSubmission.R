...
bic.net.ids = c(MayoRNAseq.CBE = 'syn8281722')
#bic.net.ids = c(ROSMAP = 'syn8268669')
...
rankCons.net.ids = c(MayoRNAseq.CBE = 'syn8281727')
#rankCons.net.ids = c(ROSMAP = 'syn8268680')
...
#module.exec.paths = c('/shared/CFinder-2.0.6--1448/', '/shared/GANXiS_v3.0.2/', replicate(7, './'));
module.exec.paths = './';
run.id = seq(1,100,1);
